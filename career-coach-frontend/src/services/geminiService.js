...
Provide constructive, actionable feedback that will help the candidate improve their CV for this specific role. Be specific and practical in your recommendations.`;
      ...
      try {
        ...
        return {
          ...
          suitability: {
            ...
            reasoning:
              "Analysis completed but requires manual review due to formatting issues",
          },
          rawResponse: text,
        };
      }
      ...
      if (
        ...
        throw new Error(
          "Invalid API key. Please check the Gemini API configuration."
        );
      } else if (
        ...
        throw new Error(
          `Failed to analyze CV: ${error.message || "Unknown error occurred"}`
        );
      }
    }
  }
